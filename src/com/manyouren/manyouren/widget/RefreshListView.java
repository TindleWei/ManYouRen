...
/** 
* from Trinea PullToRefresh-ListView
*
* @author firefist_wei
* @date 2014-6-25 下午1:15:42 
*  
*/
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private float headerPaddingTopRate = 2.5f;
	...
	private void initDropDownStyle() {
		...
		headerDefaultText = context
				.getString(R.string.refresh_list_header_default_text);
		headerPullText = context
				.getString(R.string.refresh_list_header_pull_text);
		headerReleaseText = context
				.getString(R.string.refresh_list_header_release_text);
		headerLoadingText = context
				.getString(R.string.refresh_list_header_loading_text);

		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		headerLayout = (RelativeLayout) inflater.inflate(
				R.layout.refresh_list_header, this, false);
	...
	private void initOnBottomStyle() {
		...
		footerDefaultText = context
				.getString(R.string.refresh_list_footer_default_text);
		footerLoadingText = context
				.getString(R.string.refresh_list_header_loading_text);
		footerNoMoreText = context
				.getString(R.string.refresh_list_footer_no_more_text);

		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		footerLayout = (RelativeLayout) inflater.inflate(
				R.layout.refresh_list_footer, this, false);
	...
	private void getAttrs(Context context, AttributeSet attrs) {
		TypedArray ta = context.obtainStyledAttributes(attrs,
				R.styleable.refresh_list_attr);
		isDropDownStyle = ta.getBoolean(
				R.styleable.refresh_list_attr_isDropDownStyle, false);
		isOnBottomStyle = ta.getBoolean(
				R.styleable.refresh_list_attr_isOnBottomStyle, false);
		isAutoLoadOnBottom = ta.getBoolean(
				R.styleable.refresh_list_attr_isAutoLoadOnBottom, false);
		ta.recycle();
	}
}
