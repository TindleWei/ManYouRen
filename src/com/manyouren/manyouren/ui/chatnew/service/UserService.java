...
//    RootApplication.registerBatchUserCache(users);
...
//  }
  ...
  private static List<String> getFriendIds() {
    List<User> friends = RootApplication.getInstance().getFriends();
...
//      PrefDao prefDao = new PrefDao(RootApplication.getInstance(), user.getObjectId());
...
//  }
  ...
  public static void cacheUserIfNone(String userId) throws AVException {
    if (RootApplication.lookupUser(userId) == null) {
    	RootApplication.registerUserCache(findUser(userId));
    }
  }
}
