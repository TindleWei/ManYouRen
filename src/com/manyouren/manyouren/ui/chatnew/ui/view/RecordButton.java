...
public class RecordButton extends Button {
	public static final int BACK_RECORDING = R.drawable.bg_new_record_bottom;
	public static final int BACK_IDLE = R.drawable.bg_new_record_bottom_n;
	...
	private void setTextViewByStatus() {
		if (status == RELEASE_TO_CANCEL) {
			textView.setTextColor(getColor(R.color.md_purple));
	...
	private void cancelRecord() {
		...
		recordIndicator.dismiss();
		Toast.makeText(getContext(),
				RootApplication.getInstance().getString(R.string.cancelRecord),
				Toast.LENGTH_SHORT).show();
		File file = new File(outputPath);
		if (file.exists()) {
			file.delete();
