...
* @Title: PlanTimesActivity.java 
* @Description: TODO
* @author firefist_wei firefist.wei@gmail.com   
* @date 2014-6-26 上午10:32:08 
* @version V1.0   
*/
 ...
 *  
 */
public class PlanTimesActivity extends Activity {
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    dialog.setOnClickListener(new OnClickListener() {
	      @Override public void onClick(View view) {
	        dialogView = (CalendarPickerView) getLayoutInflater().inflate(R.layout.dialog_times, null, false);
	        dialogView.init(lastYear.getTime(), nextYear.getTime()) //
	            .withSelectedDate(new Date());
	        theDialog =
	            new AlertDialog.Builder(PlanTimesActivity.this).setTitle("I'm a dialog!")
	                .setView(dialogView)
	    ...
	    findViewById(R.id.done_button).setOnClickListener(new OnClickListener() {
	      ...
	      public void onClick(View view) {
	        ...
	        Toast.makeText(PlanTimesActivity.this, toast, LENGTH_SHORT).show();
	      }
	    });
	  }
