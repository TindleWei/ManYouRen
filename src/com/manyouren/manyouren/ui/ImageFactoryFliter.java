...
import com.manyouren.manyouren.ui.RotateImageView.RotateType;
...
public class ImageFactoryFliter extends ImageFactory {
	...
	public int filter_res[] = {
			R.drawable.filter_alba,R.drawable.filter_damascus,R.drawable.filter_copacobana,
			R.drawable.filter_berlin,R.drawable.filter_havana,R.drawable.filter_helsinki,
			R.drawable.filter_original,R.drawable.filter_portland,R.drawable.filter_prague,
			R.drawable.filter_vienna };
	...
	private void initFilterBlocks() {
		...
		for (int i = 0; i < mFilterItems.size(); i++) {
			...
			image.setBackgroundResource(filter_res[i]);
