...
public class StringMatcher {
	...
	private final static char[] KOREAN_INITIAL = {'ㄱ', 'ㄲ', 'ㄴ', 'ㄷ', 'ㄸ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅃ', 'ㅅ'
		, 'ㅆ', 'ㅇ', 'ㅈ', 'ㅉ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'};
	/*
	private final static char KOREAN_UNICODE_START = '臧�;
	private final static char KOREAN_UNICODE_END = '頌�;
	private final static char KOREAN_UNIT = '旯� - '臧�;
	private final static char[] KOREAN_INITIAL = {'銊�, '銊�, '銊�, '銊�, '銊�, '銊�, '銋�, '銋�, '銋�, '銋�
		, '銋�, '銋�, '銋�, '銋�, '銋�, '銋�, '銋�, '銋�, '銋�};
	*/
