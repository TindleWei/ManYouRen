...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerReleaseMinDistance = context.getResources().getDimensionPixelSize(
                R.dimen.refresh_list_header_min);
        ...
        headerDefaultText = "点击刷新";
        headerPullText = "下拉刷新";
        headerReleaseText = "松开刷新";
        headerLoadingText = "正在刷新";

        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        headerLayout = (RelativeLayout)inflater.inflate(R.layout.refresh_list_header, this, false);
    ...
    private void initOnBottomStyle() {
        ...
        footerDefaultText = "点击加载更多";
        footerLoadingText = "加载中...";
        footerNoMoreText = "没有更多了";

        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        footerLayout = (RelativeLayout)inflater.inflate(R.layout.refresh_list_footer, this, false);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.i("dropdown","action up,getFirstVisiblePosition():"+getFirstVisiblePosition()
                		);
                /**
                ...
                if (getFirstVisiblePosition() == 0 && currentHeaderStatus != HEADER_STATUS_LOADING) {
                	 Log.i("dropdown","is load?currentHeaderStatus:"+currentHeaderStatus);
                    switch (currentHeaderStatus) {
                        case HEADER_STATUS_RELEASE_TO_LOAD:
                        	Log.i("dropdown","HEADER_STATUS_RELEASE_TO_LOAD");
                            onDropDown();
                            break;
                        case HEADER_STATUS_DROP_DOWN_TO_LOAD:
                        	Log.i("dropdown","HEADER_STATUS_DROP_DOWN_TO_LOAD");
    ...
    public void onDropDown() {
    	Log.i("drop","onDropDown:"+currentHeaderStatus+";"+HEADER_STATUS_LOADING+";"+
    			isDropDownStyle+";"+(onDropDownListener != null));
        if (currentHeaderStatus != HEADER_STATUS_LOADING && isDropDownStyle && onDropDownListener != null) {
        	Log.i("drop","onDropDownBegin");
        	onDropDownBegin();
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.refresh_list_attr);
        isDropDownStyle = ta.getBoolean(R.styleable.refresh_list_attr_isDropDownStyle, false);
        isOnBottomStyle = ta.getBoolean(R.styleable.refresh_list_attr_isOnBottomStyle, false);
        isAutoLoadOnBottom = ta.getBoolean(R.styleable.refresh_list_attr_isAutoLoadOnBottom, false);
        ta.recycle();
    }
}
