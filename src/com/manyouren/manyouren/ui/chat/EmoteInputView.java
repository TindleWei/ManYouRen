...
//	private EmoteAdapter mEmojiAdapter;
	...
	public void init() {
		...
		mDefaultAdapter = new EmoteAdapter(getContext(),
				EmotionConstants.mEmoticons_Zem);
		/*mEmojiAdapter = new EmoteAdapter(getContext(),
				EmotionConstants.mEmoticons_Zemoji);*/
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (mIsSelectedDefault) {
			text = EmotionConstants.mEmoticons_Zem.get(arg2);
		} else {
			text = EmotionConstants.mEmoticons_Zemoji.get(arg2);
		}
