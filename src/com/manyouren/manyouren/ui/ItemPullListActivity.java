 ...
 * 
 */
public abstract class ItemPullListActivity<E> extends BaseActivity
		implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.item_pull_list);
		...
		configureList(ItemPullListActivity.this, getListView());
	...
	private ItemPullListActivity<E> fadeIn(final View view,
	...
	public ItemPullListActivity<E> show(final View view) {
		ViewUtils.setGone(view, false);
		return this;
	}

	public ItemPullListActivity<E> hide(final View view) {
	 ...
	 */
	public ItemPullListActivity<E> setListShown(final boolean shown) {
